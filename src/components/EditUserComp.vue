            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input class="input" type="text" placeholder="User" name="name" v-model="editUser.userName">
                        <input class="input" type="text" placeholder="User" name="name" v-model="editUser.userSurname">
                        <input class="input" type="text" placeholder="User" name="name" v-model="editUser.userRole">
                        <input class="input" type="text" placeholder="User" name="name" v-model="editUser.userEmail">
